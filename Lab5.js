...
const moduleObj = {
  ...
  description: 'This module covers the basics of ExpressJS.',
...
// Add routes to update assignment's score and completed status
...
// Add route to update module's description
app.get("/a5/module/description/:newDescription", (req, res) => {
  ...
  res.json(moduleObj);
    ...
    app.get("/a5/divide/:a/:b", (req, res) => {
      const { a, b } = req.params;
      const quotient = b !== '0' ? parseInt(a) / parseInt(b) : 'Cannot divide by zero';
